...
It's perfectly fine to re-use this definition in the preview_generator application,
though.
...
from preview_generator.model import DeclarativeBase, metadata, DBSession
